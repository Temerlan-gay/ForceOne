...
export const MAPS: GameMap[] = [
  {
    ...
    sites: [
      { key: "A", name: "Командный центр", description: "Разрушенный CC, узкие проходы и много укрытий." },
      { key: "B", name: "Контейнерный двор", description: "Открытая зона с башнями и снайперскими позициями." },
    ],
  ...
  },
  {
    ...
    sites: [
      { key: "A", name: "Plaza", description: "Торговый центр с голограммами, лестницы и закрытые залы." },
  ...
  },
  {
    ...
    sites: [
      { key: "A", name: "Купол-лаборатория", description: "Узкие коридоры внутри исследовательского купола." },
      { key: "B", name: "Внешний периметр", description: "Открытая зона со снежной бурей и плохой видимостью." },
    ],
  ...
  },
  {
    ...
    timeOfDay: "day",
    dynamicCycle: true,
    designNotes: ["каменные руины + голограммы", "энергия в центре карты", "смесь древнего и футуризма"],
    sites: [
      { key: "A", name: "Внутренний храм", description: "Узкие коридоры и арки внутри святилища." },
      { key: "B", name: "Двор ядра", description: "Открытый двор с энергетическим ядром в центре." },
    ],
